...
import { responseArrayFormater } from "@helpers/responseFormater";
...
const InstantTemplate: FC<PROPS> = ({
    ...
    useEffect(() => {
        const getData = () => {
            get("", {
                ...
                .then((resp) => {
                    //  change response array to normal object
                    if (Array.isArray(resp)) resp = responseArrayFormater(resp);
    ...
    const clearFilter = () =>
        handleSearchData({ ...defaultParams, search: "" });
            ...
            <Wrapper>
                ...
                <TableContainer>
                    ...
                    <Table
                        className={cx(
                            "mb-0",
                            cssSetColumnTableWidth(tableFixed),
                        )}
                        size="medium"
                        stickyHeader
                    >
